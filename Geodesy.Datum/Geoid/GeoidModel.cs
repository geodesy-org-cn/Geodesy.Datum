...
namespace Geodesy.Datum.Geoid
{
    ...
    /// 
    /// </summary>
    public class GeoidModel : IGeoidModel
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// 
        /// </summary>
        public double Left { get; protected set; } = 0;

        /// <summary>
        /// 
        /// </summary>
        public double Right { get; protected set; } = 360;

        /// <summary>
        /// 
        /// </summary>
        public double Top { get; protected set; } = 90;

        /// <summary>
        /// 
        /// </summary>
        public double Bottom { get; protected set; } = -90;

        /// <summary>
        /// 
        /// </summary>
        protected FileStream _reader;
        ...
        {
            return GetHeight(lat.Degrees, lng.Degrees);
        }
        ...
        public double GetHeight(double lat, double lng)
        {
            ...
            else
            {
                ...
                int[] position = GetBoundary(ref lat, ref lng);

                // read the grid value
                double[] h = ReadGrid(position);
        ...
        /// <returns></returns>
        public virtual int[] GetBoundary(ref double lat, ref double lng)
        {
            int i1, i2, j1, j2;
        ...
        /// <returns></returns>
        public virtual double[] ReadGrid(int[] position)
        {
            #region embedded geoid model, geoid heights are derived from EGM96 (1 x 1 deg grid)
            float[,] geoid = new float[361, 181] {{
            ...
            h[0] = geoid[position[0], position[2]];
            h[1] = geoid[position[1], position[2]];
            h[2] = geoid[position[0], position[3]];
            h[3] = geoid[position[1], position[3]];
        ...
        /// <param name="y"></param>
        /// <returns></returns>
        private double BilinearInterpolation(double[] h, double x, double y)
        {
